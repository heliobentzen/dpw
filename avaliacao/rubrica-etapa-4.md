...
| A4 | **Modelo e arquitetura** | Diagramas corretos, legíveis, explicados no texto | Diagramas presentes e citados | Diagramas sem explicação | Ausentes | |
| A5 | **Resultados** | Critérios da Etapa 1 confrontados com evidências; metas não alcançadas analisadas | Resultados apresentados com evidência | Resultados afirmados sem evidência | Ausentes ou maquiados | |
| A6 | **Honestidade** | Limitações, bugs conhecidos e desvios de cronograma declarados e analisados | Limitações declaradas | Omissões relevantes | Relatório que esconde problemas | |
| A7 | **Escrita** | Texto claro, coeso, revisado; sem enchimento | Boa redação | Erros frequentes | Texto confuso ou genérico | |
| A8 | **Normas e referências** | ABNT correta; figuras e tabelas numeradas e citadas; referências completas | Normas seguidas | Aplicação irregular | Sem normalização | |
...
| B4 | **Dificuldades** | Assumidas com análise do que se aprendeu | Dificuldades relatadas | Mencionadas de passagem | "Correu tudo bem" | |
| B5 | **Aprendizados individuais** | Reflexões pessoais substantivas de todos | Todos escreveram | Alguns escreveram, protocolarmente | Ausentes | |
...
| C4 | **Participação** | Todos falam, com divisão equilibrada e transições ensaiadas | Todos falam | Um ou dois dominam | Uma pessoa apresenta tudo | |
| C5 | **Tempo e recursos** | Dentro do tempo; slides limpos; plano B preparado | Dentro do tempo | Estourou ou faltou tempo | Descontrolado | |
| C6 | **Arguição individual** | Cada integrante responde com precisão sobre partes que não escreveu | Respostas corretas | Respostas hesitantes | Não sabe responder | |
...
| D4 | **Devolutiva** | Realizada na organização, com escuta registrada e incorporada ao relatório | Realizada, com ata | Contato superficial | Não realizada | |
| D5 | **Sustentabilidade** | Custo, suporte, backup e licença definidos; a organização sabe como seguir sozinha | Definidos e documentados | Parcialmente definidos | Sistema entregue e abandonado | |
...
| C. Apresentação | 3 | | |
| D. Encerramento | 3 | | |
| E. Avaliação por pares | 1 | | |
| **Total** | **14** | | |

**Nota da etapa** = (soma ponderada ÷ 56) × 10
...
- [ ] Apresentação não realizada
- [ ] Sistema não transferido à organização parceira
...
**Fator de participação por integrante:**

| Integrante | Fator | Justificativa |
|---|---:|---|
| | | |
