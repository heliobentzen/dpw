...
Aprovado quem cumprir, **cumulativamente**:
...
| Observação do docente | Participação nas aulas e nos rituais |

Divergência grande entre as fontes é investigada em conversa individual antes de qualquer
...
| 0,8 | Participação esporádica |
| 0,7 | Participação mínima; não domina o que foi entregue |
...
| Até 7 dias | −25% |
| Mais de 7 dias | Não aceita (salvo justificativa formal) |

Entregas de equipe atrasadas afetam a equipe inteira — é parte do aprendizado de trabalho
...
**Proibido:** entregar como próprio trabalho de outra equipe; entregar código que a equipe
não sabe explicar; falsificar evidências da ação extensionista; assinar documento em nome
de terceiro.
